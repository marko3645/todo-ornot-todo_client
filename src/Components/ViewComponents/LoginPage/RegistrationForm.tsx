...
export class RegistrationForm extends React.Component<RegistrationFormState, RegistrationFormState> {
	...
	private BuildValidationService() {
		...
		return builder
			.NotEmpty(this.BuildGetValueFunction(this.Inputs.TxtUsername), this.Inputs.TxtUsername)
			.NotEmpty(this.BuildGetValueFunction(this.Inputs.TxtPassword), this.Inputs.TxtPassword)
			.NotEmpty(this.BuildGetValueFunction(this.Inputs.TxtConfirmPassword), this.Inputs.TxtConfirmPassword)
			.Build();
	}
		...
		return (
			<React.Fragment>
				...
				<Form disabled={this.state.isRegistering}>
					...
					/>
					<StyledTextbox name={this.Inputs.TxtPassword} LabelText="Password" ErrorText={this.ErrorText(this.Inputs.TxtPassword)} />
					<StyledTextbox
					...
					<LoginButtonContainer>
						...
						<TotButton type="outlined" LabelText="LOG IN" />
					</LoginButtonContainer>
				</Form>
			</React.Fragment>
		);
	...
	private BuildHeading() {
		return (
			<HeadingContainer>
				<div className="TotHeading__Text_Top TotHeading__Text">Feel free to</div>
				...
				<div className="TotHeading__Text_Bottom TotHeading__Text">It'll be quick</div>
			</HeadingContainer>
		);
	}
	...
	private BuildRegisterButton() {
		...
		return <BtnRegister LabelText="REGISTER" className={classNames} onClick={this.OnRegisterClick} preloader={preloader} />;
	}
